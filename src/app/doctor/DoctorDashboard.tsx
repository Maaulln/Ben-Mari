      ...
      setJadwalHariIni(
        jadwalData.sort((a, b) => {
          if (
            ...
            return a.jam_appointment.localeCompare(
              b.jam_appointment
            );
          }
